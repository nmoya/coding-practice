...
class WordSearchTest(unittest.TestCase):
    ...
    def test_should_locate_the_same_word_written_left_to_right_in_a_different_position(self):
    ...
    def test_should_locate_that_different_left_to_right_word_in_a_different_position(self):
    ...
    def test_should_locate_that_left_to_right_word_in_a_different_position_in_a_ten_line_grid(self):
        puzzle = WordSearch(
            [
                "jefblpepre",
                "camdcimgtc",
    ...
    def test_should_locate_multiple_words_written_in_different_horizontal_directions(self):
        puzzle = WordSearch(
            [
                "jefblpepre",
                "camdcimgtc",
